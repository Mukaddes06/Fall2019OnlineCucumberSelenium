...
Feature: Create calendar event
  As user, I want to be abe to create calendar events.

  Scenario: Create calendar event as sales manager
    Given  user is on the login page
    When user logs in as a sales manager
    And user navigates to "Activities" and "Calendar Events"
    And user enters "On this meeting we discuss what went well, what went wrong and what can we improved" as a description
    And user enters "Sprint Retrospective" as title
    Then user click on save and close button
    And user verifies that description of new calendar event is "On this meeting we discuss what went well, what went wrong and what can we improved"
